...
export const DATASET_REGISTRY: DatasetMetadata[] = [
  ...
  },
  {
    ...
    notes: "Likert aggregates at pilot anchor; no reliable coordinates in SharePoint inventory.",
  },
  {
    ...
    updateStatus: "static",
    responsiblePartner: "Trikala",
    notes: "Safety and active-mode share proxies from questionnaire responses.",
  },
  {
    ...
    updateStatus: "static",
    responsiblePartner: "Trikala",
    notes: "Legacy pilot indicators entry; survey parsers supply observed KPI proxies.",
  },
];
