...
export const DATASET_REGISTRY: DatasetMetadata[] = [
  // ─── ISSY-LES-MOULINEAUX ──────────────────────────────────────────────────
  {
    ...
    linkedKpis: ["kpi2.1", "kpi3.2"],
    interventionScale: "street",
    parserStatus: "ready",
    realDataStatus: "active",
    updateStatus: "live",
    responsiblePartner: "Issy-les-Moulineaux",
    notes: "Live API, speed + congestion per road segment. Used as Road User Safety proxy.",
  },
  {
  ...
  },
  {
    ...
    source: "SharePoint: Issy/2. POST IMPLEMENTATION DATA",
    fileFormat: "csv",
    dataType: "observed",
    geometryType: "segment",
    geometryQuality: "matched",
    spatialLinkageMethod: "segment-join",
    temporalCoverage: "Pre-Nov 2025",
    ...
    updateStatus: "static",
    responsiblePartner: "Issy-les-Moulineaux",
    notes: "Zone-to-zone OD matrix. Geometry inferred from zone centroids.",
  },
  {
    ...
    source: "SharePoint: Issy/2. POST IMPLEMENTATION DATA (Nov 2025)",
    fileFormat: "csv",
    dataType: "observed",
    geometryType: "segment",
    geometryQuality: "matched",
