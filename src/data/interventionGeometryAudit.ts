...
const PILOT_GEOMETRY_ROW_METADATA: PilotGeometryRow[] = [
  ...
  },
  {
    ...
    pilotId: "tri-p1",
    pilotLabel: "P1",
    intervention: "Smart crossing",
    geometryType: "Intersection",
    geometryAvailable: "Survey xlsx only; no GIS for crossing location",
    recommendedDashboard: "Smart-crossing junction at pilot anchor until coordinates delivered",
    dashboardFirstMode: "point-first",
    confidence: "low",
    confidenceRationale: "Survey aggregates only; geometry inferred at anchor.",
    currentImplementationGap: "Must not imply precise crossing geometry.",
  },
];
