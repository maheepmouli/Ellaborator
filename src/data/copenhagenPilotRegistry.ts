  ...
  "cph-p1": {
    ...
    evaluation: {
      ...
      caveats: [
        ...
        "Manual counts are shared with Pilot 3 — not used on Pilot 2.",
      ],
    },
  ...
  "cph-p2": {
    ...
    evaluation: {
      ...
      caveats: [
        ...
        "Manual traffic counts are out of scope for Pilot 2 — use Pilot 1 / Pilot 3 for those layers.",
      ],
    },
  ...
  "cph-p3": {
    ...
    evaluation: {
      ...
      caveats: [
        ...
        "Manual counts support Pilots 1 and 3 only — not Pilot 2 (bike parking).",
      ],
    },
