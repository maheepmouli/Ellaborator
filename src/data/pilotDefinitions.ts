  ...
  zaragoza: [
    {
      ...
      datasets: [
        "School traffic monitoring (Azua / M Salas)",
        "ManualCounting_June2025_AYZGZ1",
        "AirQuality Nanoenvi EQ",
      ],
      dataCompleteness: "partial",
      datasetType: "observed",
    },
    {
      ...
      supportedKpis: ["kpi1.2", "kpi2.1", "kpi3.2", "kpi4.1", "kpi4.2"],
      datasets: [
        "Comparativa KPIs baseline",
        "RoadSafetyCitizenSurvey",
        "Barriers and Citizen Expectations survey",
        "Romareda reformado GIS",
      ],
      dataCompleteness: "partial",
      datasetType: "observed",
    },
    {
      ...
      lat: 41.63301,
      lng: -0.90181,
      // Official Evaluation Plan (May 2025): 2.1 + 4.2 only. No 1.1/1.2/3.x/4.1 for AYZG3.
      supportedKpis: ["kpi2.1", "kpi4.2"],
      datasets: ["Intervention area shapefile", "Citizen survey hospital themes"],
      dataCompleteness: "limited",
      datasetType: "derived",
    },
  ],
