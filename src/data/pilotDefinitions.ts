...
export const CITY_PILOTS: Record<string, SelectedPilot[]> = {
  ...
  milan: [
    ...
    },
    {
      ...
      description:
        "Decision Support System for planning and prioritising accessibility improvements in public spaces — OSM barrier mapping, DSS tool integration, and pre/post evaluation along Olympic Routes and West Axis.",
      interventionType: "Accessibility DSS (CDM3)",
      goal: "Increase walking/cycling mode share, achieve ≥3-star safety ratings, and enhance accessibility for vulnerable users as a replicable district model.",
      scale: "city",
      lat: 45.468,
      lng: 9.215,
      supportedKpis: ["kpi1.2", "kpi2.1", "kpi3.2", "kpi4.1", "kpi4.2"],
      datasets: ["DSS walk graph", "OSM barrier mapping", "CDM3 accessibility workbook", "Corridor mock evaluation"],
      dataCompleteness: "partial",
      datasetType: "derived",
    },
  ],
