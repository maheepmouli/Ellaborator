...
const SEGMENT_THEME: Record<string, TrikalaThemeId> = {
  ...
  "tri-p3-bike-lane": "infrastructure",
  "tri-p2-park-ride": "infrastructure",
...
const SUB_SEGMENT_ACCENT: Record<string, string> = {
  ...
  "tri-p3-bike-lane": "#22c55e",
  "tri-p2-park-ride": "#63ccff",
...
const SUB_SEGMENT_LABEL: Record<string, string> = {
  ...
  "tri-p3-bike-lane": "Bike lane survey",
  "tri-p2-park-ride": "Park & Ride",
